  ...
  return (function () {
          ...
          function a(t, a) {
            for (var i = {}, o = [], l = 0; l < t.length; l++) {
              ...
              if (-1 !== d) e[d].references++, e[d].updater(h);
                ...
                var p = s(h, a);
                (a.byIndex = l),
                  e.splice(l, 0, {identifier: u, updater: p, references: 1});
              }
              o.push(u);
            }
            return o;
    ...
    return (
      (function () {
        ...
        g = z.contains('layout-navbar-fixed')
          ? 'sticky'
        ...
        var w =
          ...
          E = z.contains('layout-menu-offcanvas')
            ? 'static-offcanvas'
                ...
                if (
                  ...
                  -1 !== q &&
                    (this.settings.controls = this.settings.controls
                      .slice(0, q)
                      .concat(this.settings.controls.slice(q + 1)));
                }
              ...
              (n = [
                    ...
                    if (
                      ...
                      'fixed-offcanvas' === this.settings.headerType
                        ? a &&
                          ...
                          (window.Helpers.menuPsScroll = n))
                        : n && window.Helpers.menuPsScroll.destroy();
                    }
                  },
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (e !== this.settings.lang || a) {
                      ...
                      for (
                        ...
                        ).textContent = i[c] || this._getThemeByName(c).title;
                      }
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    '' !== m
                      ...
                      (this.settings.headerType = t),
                      (this.settings.rtl =
                        '' !== n ? 'true' === n : this.settings.defaultTextDir),
                      (this.settings.stylesOpt =
                        -1 !== this.settings.styles.indexOf(a)
                          ? a
                      ...
                      (this.settings.layoutCollapsed =
                        '' !== o ? o : this.settings.defaultMenuCollapsed),
                      (this.settings.showDropdownOnHover =
                        '' !== l
                          ? 'true' === l
                          : this.settings.defaultShowDropdownOnHover),
                      (e =
                        '' !== r &&
                        -1 !== ['static', 'sticky', 'hidden'].indexOf(r)
                          ? r
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var y = this.container.querySelector(
                    ...
                    if (
                      ...
                      if (this._hasControls('layoutCollapsed')) {
                        ...
                        (N =
                          'true' === this.settings.layoutCollapsed
                            ? 'collapsed'
                            : 'expanded'),
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    ...
                    if (
                      ...
                      if (!n) return;
                      if (e === n.getAttribute('href')) return;
                  ...
                  value: function (t) {
                    ...
                    try {
                      e = localStorage.getItem(
                        'templateCustomizer-'.concat(n, '--').concat(t),
                      );
                    } catch (t) {}
                    return String(e || '');
                  },
                  ...
                  value: function () {
                    var t = this,
                      e =
                        ...
                        arguments[0];
                    setTimeout(function () {
                      var n = t.container.querySelector(
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    return t.split(' ').reduce(function (t, a) {
                      return (
                        -1 !== e.settings.controls.indexOf(a)
                          ? (n || !1 !== t) && (t = !0)
                          : (n && !0 === t) || (t = !1),
                        t
                      );
                  ...
                  value: function (t) {
                    for (
                      var e =
                          ...
                          void 0 !== arguments[1] &&
                          arguments[1],
                        n = this.settings.availableThemes,
                        a = 0,
                        s = n.length;
                      a < s;
                      a++
